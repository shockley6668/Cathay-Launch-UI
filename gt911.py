...
def scan_i2c():
    # GT911 on Waveshare board defaults to 0x5D
    return ['0x5d', '0x14']
...
class gt911():
    ...
    def touch_rst(self):
        # INT low during reset selects I2C address 0x5D
    ...
    def configure_resolution(self):
        ...
        self.write_register(X_OUTPUT_MAX_LOW_REG, COORDINATE_X_MAX & 0xFF)
        self.write_register(X_OUTPUT_MAX_HIGH_REG, (COORDINATE_X_MAX >> 8) & 0x0F)
        # Set Y-axis resolution (low 8 bits + high 4 bits)
        self.write_register(Y_OUTPUT_MAX_LOW_REG, COORDINATE_Y_MAX & 0xFF)
        self.write_register(Y_OUTPUT_MAX_HIGH_REG, (COORDINATE_Y_MAX >> 8) & 0x0F)

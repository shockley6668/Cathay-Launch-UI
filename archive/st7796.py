...
class st7796():
    def __init__(self):
        ...
        self.GPIO_RST_PIN = RST_PIN
        self.GPIO_DC_PIN  = DC_PIN
        self.GPIO_BL_PIN  = BL_PIN
        
        self.bl_DutyCycle(100)    
        #Initialize SPI (RDK X5 SPI1 bus, CE1 pin 24)
    ...
    def bl_DutyCycle(self, duty):                   # Set PWM duty cycle
        if duty > 0:
            GPIO.output(self.GPIO_BL_PIN, GPIO.HIGH)
        else:
            GPIO.output(self.GPIO_BL_PIN, GPIO.LOW)
